		...
		<div id="main">
							...
							<div id="rev_slider" class="rev_slider fullscreenbanner">
								<ul>
									<li data-transition="fade" data-slotamount="default"
										...
										src="images/slider/slide_bg_4.jpg" alt=""
										...
										data-paddingleft="[30,30,30,30]">Shop Now </a></li>
								</ul>
							</div>
						</div>
					</div>
			...
			<div class="section section-bg-3 pt-6 pb-6">
				<div class="container">
					<div class="row">
						<div class="col-sm-12">
							<div class="text-center mb-1 section-pretitle">选择我们</div>
							<h2 class="text-center section-title mtn-2">四个理由</h2>
					...
					<div class="row">
						<div class="col-md-4">
							...
							<p>Cur tantas regiones barbarorum peat dibus obiit, tregiones
